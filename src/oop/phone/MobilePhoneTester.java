...
public class MobilePhoneTester {
    public static void main(String[] args) {
        ...
        MobilePhone samsung2 = new MobilePhone("Samsung2", "Galaxy S9", 1000, 500); //Where 1000 - is battery capacity, and 500 is memory amount;
        System.out.println("samsung.hashCode() = " + samsung2.hashCode());
